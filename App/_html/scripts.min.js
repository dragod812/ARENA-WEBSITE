...
var $W=$(window),$D=$(document),$H=$("html"),$B=$("body");$(function(){function e(e){c=!0;var a=e,s=a-1,o=a+1;n=a,h.removeClass("_hidden"),1==a?h.addClass("_hidden"):a==i&&h.filter("._next").addClass("_hidden"),1==a?(t("menu"),m.removeClass("_hide"),_.removeClass("active inactive")):(t("close"),m.addClass("_hide")),1!=a?p.addClass("_filled"):p.removeClass("_filled"),$(".page-"+a).removeClass("active").addClass("inactive"),$(".page-"+a).removeClass("inactive").addClass("active"),$(".page-"+o).removeClass("active"),setTimeout(function(){$(".page-"+s).addClass("active inactive"),c=!1},l)}function a(){1!==n&&e(n-1)}function s(){n!==i&&e(n+1)}function o(){C.removeClass("_small _big _opened"),$B.removeClass("_open-how"),h.removeClass("_hidden"),setTimeout(function(){C.hasClass("_hover")||C.css("zIndex",0)},r)}function t(e){v.removeClass("_close _menu _back").addClass("_"+e)}var n=1,i=6,l=1e3,r=600,c=!1,d=!1,_=$(".page"),p=$(".js-footer"),v=$(".js-menu-btn"),m=$(".js-user-btn"),u=$(".js-goto-btn"),h=$(".js-page-nav"),f=$(".js-mob-menu-close"),C=$(".js-how-to-block");u.on("click",function(){if(!c){var a=$(this),s=a.data("href");a.hasClass("_mob")?($B.removeClass("_menu-open"),setTimeout(function(){e(s)},300)):e(s)}}),h.on("click",function(){if(!c){var a=$(this);if(a.hasClass("_prev")){if(1===n)return;e(n-1)}else if(a.hasClass("_next")){if(n===i)return;e(n+1)}}}),C.on("click",function(){if(!d){var e=$(this);d=!0,e.hasClass("_big")?(o(),t("close"),h.removeClass("_hidden")):(C.addClass("_small"),h.addClass("_hidden"),e.css("zIndex",2).addClass("_big").removeClass("_small"),t("back"),setTimeout(function(){e.addClass("_opened"),$B.addClass("_open-how")},r)),setTimeout(function(){d=!1},r)}}),v.on("click",function(){var a=$(this);a.hasClass("_close")?(n=1,e(n)):a.hasClass("_menu")?$B.hasClass("_menu-open")?$B.removeClass("_menu-open"):$B.addClass("_menu-open"):a.hasClass("_back")&&(o(),t("close"))}),f.on("click",function(){$B.removeClass("_menu-open")}),$(document).on("click",function(e){!$B.hasClass("_menu-open")||$(e.target).closest(".js-mob-menu").length||$(e.target).closest(".js-menu-btn").length||$B.removeClass("_menu-open")}),$(function(){function e(e){var a=TweenLite.to(".preloader__start, .preloader__progress, .rotater",_,{opacity:0}),s=TweenLite.to(t,v,{x:"+=540%",y:"-=600%",ease:Back.easeIn}),o=TweenLite.to(n,r,{x:"+=270%",y:"-=300%",opacity:1}),i=TweenLite.to(".logo__path-dot",r,{opacity:1}),l=d+_,c=l+v;u.add(a,d),u.add(s,l),u.add(o,c),u.add(i,c),u.play()}function o(){$(".central-nav").addClass("active"),$(".central-desc").addClass("active"),$(".js-header-logo").addClass("_complete"),$B.addClass("_loaded"),$(document).on("mousemove",B),$(document).on("mousewheel DOMMouseScroll",function(e){c||$B.hasClass("_popup")||$B.hasClass("_open-how")||$B.hasClass("_menu-open")||(e.originalEvent.wheelDelta>0||e.originalEvent.detail<0?a():s())})}var t=".preloader__plane-path",n=".logo__path-plane",i=g__options.preloader.animTime||2.3,l=7,r=i/l,d=.2,_=.3,p=.3,v=g__options.preloader.planeFlyAnimTime||.7,m=new TimelineLite({onComplete:e,delay:p}),u=new TimelineLite({paused:!0,onComplete:o});TweenLite.set(n,{x:"-=270%",y:"+=300%"}),TweenLite.to(".rotater",i,{delay:p,rotation:"+=360",ease:Power1.easeIn}),TweenLite.to(".preloader__progress",i,{delay:p,drawSVG:"0% 100%",ease:Power1.easeIn});for(var h=1;l>=h;h++){var f=TweenLite.to(t,r,{morphSVG:{shape:".preloader__plane-step-"+h}});m.add(f,(h-1)*r)}var C=$(window).width()/2,w=$(window).height()/2,g=14,b=parseFloat(C/g),T=parseFloat(w/g),k=$(".central-nav__rotating-plane"),j=function(){C=$(window).width()/2,w=$(window).height()/2,b=+parseFloat(C/g),T=+parseFloat(w/g)};$(window).resize(j);var B=function(e){var a=parseFloat((e.pageX-C)/b),s=parseFloat((e.pageY-w)/T);k.css("transform","rotateX("+(0-s)+"deg) rotateY("+a+"deg) rotateZ(0)")},L=.3;$(".central-nav__item").hover(function(){var e=$(".central-nav__item-circle_inner",this),a=$(".central-nav__item-circle_outer",this);TweenLite.to(e,L,{attr:{r:19.5},fill:"#18e28f"}),TweenLite.to(a,L,{attr:{r:29.5},fill:"rgba(24, 226, 143, 0.05)",stroke:"rgba(24, 226, 143, 0)"})},function(){var e=$(".central-nav__item-circle_inner",this),a=$(".central-nav__item-circle_outer",this);TweenLite.to(e,L,{attr:{r:7.5},fill:"#faf2f0"}),TweenLite.to(a,L,{attr:{r:12.5},fill:"rgba(24, 226, 143, 0)",stroke:"rgba(250, 242, 240, 0.5)"})})})}),$(function(){function e(){o.each(function(){var e=$(this);e.css("margin-top",Math.floor(e.height()/-2)+"px")})}var a=$(".js-if-slider");if(a.length){var s=$(".js-if-slider-btn");s.on("click",function(){var e=$(this),o=e.data("id"),t=$(".js-if-slide",a);s.removeClass("_active"),e.addClass("_active"),t.removeClass("_active"),t.eq(o).addClass("_active")});var o=$(".js-if-slide",a);setTimeout(function(){e()},1500),$(window).on("resize",e)}}),$(function(){var e=$(".js-ic-popup");if(e.length){var a={btn:$(".js-case"),btnClose:$(".js-ic-popup-close"),sliderWr:$(".js-ic-slider")};a.sliderWr.slick({infinite:!0,slidesToShow:1,slidesToScroll:1,dots:!1,arrows:!1,mobileFirst:!0,accessibility:!1,responsive:[{breakpoint:768,settings:{arrows:!0}}]});a.btn.on("click",function(){var s=$(this),o=s.data("id");wScroll=$W.scrollTop(),e.css("top",wScroll),$B.hasClass("_popup")||$B.addClass("_popup"),e.hasClass("_active")?a.sliderWr[0].slick.slickGoTo(o,!1):(a.sliderWr[0].slick.slickGoTo(o,!0),e.addClass("_active"))}),a.btnClose.on("click",function(){$B.removeClass("_popup"),e.removeClass("_active")})}});
