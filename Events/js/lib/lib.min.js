if (function(t, e) {
        ...
        function v(t, e) {
            ...
            if (!r)
                for (r = [], n = t.childNodes || t; null != (i = n[o]); o++) !e || ot.nodeName(i, e) ? r.push(i) : ot.merge(r, v(i, e));
        ...
        function $(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++) i = t[s], i.style && (r[s] = ot._data(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && $t(i) && (r[s] = ot._data(i, "olddisplay", S(i.nodeName)))) : (o = $t(i), (n && "none" !== n || !o) && ot._data(i, "olddisplay", o ? n : ot.css(i, "display"))));
        ...
        function A(t, e, n, i, o) {
            for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === n && (s += ot.css(t, n + kt[r], !0, o)), i ? ("content" === n && (s -= ot.css(t, "padding" + kt[r], !0, o)), "margin" !== n && (s -= ot.css(t, "border" + kt[r] + "Width", !0, o))) : (s += ot.css(t, "padding" + kt[r], !0, o), "padding" !== n && (s += ot.css(t, "border" + kt[r] + "Width", !0, o)));
            return s
        }
        ...
        function R(t, e, n) {
            ...
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], u = ot.css(t, "display"), c = "none" === u ? ot._data(t, "olddisplay") || S(t.nodeName) : u, "inline" === c && "none" === ot.css(t, "float") && (nt.inlineBlockNeedsLayout && "inline" !== S(t.nodeName) ? f.zoom = 1 : f.display = "inline-block")), n.overflow && (f.overflow = "hidden", nt.shrinkWrapBlocks() || d.always(function() {
            ...
            if (ot.isEmptyObject(p)) "inline" === ("none" === u ? S(t.nodeName) : u) && (f.display = u);
            else {
        ...
        var ut = function(t) {
            function e(t, e, n, i) {
                ...
                if ((e ? e.ownerDocument || e : F) !== L && j(e), e = e || L, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a) return n;
                if (!i && I) {
                    if (11 !== a && (o = yt.exec(t)))
                        if (s = o[1]) {
                            if (9 === a) {
                    ...
                    if (w.qsa && (!H || !H.test(t))) {
                        if (f = d = M, h = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
            ...
            function f(t, e, n) {
                ...
                return e.first ? function(e, n, r) {
                    ...
                    if (s) {
                        ...
                        for (; e = e[i];)
                            if (1 === e.nodeType || o) {
                                if (l = e[M] || (e[M] = {}), (a = l[i]) && a[0] === q && a[1] === r) return u[2] = a[2];
            ...
            var x, w, T, C, E, S, N, k, $, D, A, j, L, O, I, H, R, _, P, M = "sizzle" + 1 * new Date,
                F = t.document,
                q = 0,
                B = 0,
                W = n(),
            ...
            w = e.support = {}, E = e.isXML = function(t) {
                ...
                return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, O = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), I = !E(i), w.attributes = o(function(t) {
                    ...
                    return O.appendChild(t).id = M, !i.getElementsByName || !i.getElementsByName(M).length
                ...
                }, R = [], H = [], (w.qsa = mt.test(i.querySelectorAll)) && (o(function(t) {
                    O.appendChild(t).innerHTML = "<a id='" + M + "'></a><select id='" + M + "-\f]' msallowcapture=''><option selected=''></option></select>", t.querySelectorAll("[msallowcapture^='']").length && H.push("[*^$]=" + nt + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || H.push("\\[" + nt + "*(?:value|" + et + ")"), t.querySelectorAll("[id~=" + M + "-]").length || H.push("~="), t.querySelectorAll(":checked").length || H.push(":checked"), t.querySelectorAll("a#" + M + "+*").length || H.push(".#.+[+~]")
                }), o(function(t) {
                ...
                }), H = H.length && new RegExp(H.join("|")), R = R.length && new RegExp(R.join("|")), e = mt.test(O.compareDocumentPosition), P = e || mt.test(O.contains) ? function(t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === F && P(F, t) ? -1 : e === i || e.ownerDocument === F && P(F, e) ? 1 : D ? tt(D, t) - tt(D, e) : 0 : 4 & n ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return A = !0, 0;
                    var n, o = 0,
                        r = t.parentNode,
                        ...
                        return 1 === i && 0 === o ? function(t) {
                            ...
                            if (v) {
                                ...
                                if (h = [s ? v.firstChild : v.lastChild], s && y) {
                                    for (c = v[M] || (v[M] = {}), u = c[t] || [], f = u[0] === q && u[1], p = u[0] === q && u[2], d = f && v.childNodes[f]; d = ++f && d && d[g] || (p = f = 0) || h.pop();)
                                        if (1 === d.nodeType && ++p && d === e) {
                                            c[t] = [q, f, p];
                                            break
                                        }
                                } else if (y && (u = (e[M] || (e[M] = {}))[t]) && u[0] === q) p = u[1];
                                else
                                    for (;
                                        (d = ++f && d && d[g] || (p = f = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== m : 1 !== d.nodeType) || !++p || (y && ((d[M] || (d[M] = {}))[t] = [q, p]), d !== e)););
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, S = e.tokenize = function(t, n) {
                ...
                for (a = t, l = [], u = T.preFilter; a;) {
                    ...
                    for (s in T.filter) !(o = ht[s].exec(a)) || u[s] && !(o = u[s](o)) || (i = o.shift(),
                        r.push({
                            value: i,
                            type: s,
                            matches: o
                ...
                return (u || N(t, d))(i, e, !I, n, bt.test(t) && c(e.parentNode) || e), n
            }, w.sortStable = M.split("").sort(X).join("") === M, w.detectDuplicates = !!A, j(), w.sortDetached = o(function(t) {
        ...
        ot.event = {
            ...
            add: function(t, e, n, i, o) {
                var r, s, a, l, u, c, d, p, f, h, g, v = ot._data(t);
                if (v) {
                    for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = ot.guid++), (s = v.events) || (s = v.events = {}), (c = v.handle) || (c = v.handle = function(t) {
            ...
            remove: function(t, e, n, i, o) {
                var r, s, a, l, u, c, d, p, f, h, g, v = ot.hasData(t) && ot._data(t);
                if (v && (c = v.events)) {
                    for (e = (e || "").match(bt) || [""], u = e.length; u--;)
                        if (a = Ht.exec(e[u]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
                            ...
                            l && !p.length && (d.teardown && d.teardown.call(t, h, v.handle) !== !1 || ot.removeEvent(t, f, v.handle), delete c[f])
                        } else
                            for (f in c) ot.event.remove(t, f + e[u], n, i, !0);
                    ot.isEmptyObject(c) && (delete v.handle, ot._removeData(t, "events"))
                }
            },
        ...
        Yt.optgroup = Yt.option, Yt.tbody = Yt.tfoot = Yt.colgroup = Yt.caption = Yt.thead, Yt.th = Yt.td, ot.extend({
            clone: function(t, e, n) {
                ...
                if (nt.html5Clone || ot.isXMLDoc(t) || !Pt.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (Gt.innerHTML = t.outerHTML, Gt.removeChild(r = Gt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ot.isXMLDoc(t)))
                    for (i = v(r), a = v(t), s = 0; null != (o = a[s]); ++s) i[s] && C(o, i[s]);
                if (e)
                    if (n)
            ...
            buildFragment: function(t, e, n, i) {
                for (var o, r, s, a, l, u, c, d = t.length, p = g(e), f = [], h = 0; d > h; h++)
                    ...
                    for (a = a || p.appendChild(e.createElement("div")), l = (qt.exec(r) || ["", ""])[1].toLowerCase(), c = Yt[l] || Yt._default, a.innerHTML = c[1] + r.replace(Ft, "<$1></$2>") + c[2], o = c[0]; o--;) a = a.lastChild;
                    if (!nt.leadingWhitespace && Mt.test(r) && f.push(e.createTextNode(Mt.exec(r)[0])), !nt.tbody)
                ...
                for (a && p.removeChild(a), nt.appendChecked || ot.grep(v(f, "input"), m), h = 0; r = f[h++];)
                    if ((!i || -1 === ot.inArray(r, i)) && (s = ot.contains(r.ownerDocument, r), a = v(p.appendChild(r), "script"), s && w(a), n))
            ...
            remove: function(t, e) {
                for (var n, i = t ? ot.filter(t, this) : this, o = 0; null != (n = i[o]); o++) e || 1 !== n.nodeType || ot.cleanData(v(n)), n.parentNode && (e && ot.contains(n.ownerDocument, n) && w(v(n, "script")), n.parentNode.removeChild(n));
                return this
            },
            empty: function() {
            ...
            html: function(t) {
                return Dt(this, function(t) {
                    ...
                    if ("string" == typeof t && !zt.test(t) && (nt.htmlSerialize || !Pt.test(t)) && (nt.leadingWhitespace || !Mt.test(t)) && !Yt[(qt.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(Ft, "<$1></$2>");
                        try {
            ...
            domManip: function(t, e) {
                ...
                if (u && (a = ot.buildFragment(t, this[0].ownerDocument, !1, this), n = a.firstChild, 1 === a.childNodes.length && (a = n), n)) {
                    for (r = ot.map(v(a, "script"), b), o = r.length; u > l; l++) i = a, l !== d && (i = ot.clone(i, !0, !0), o && ot.merge(r, v(i, "script"))), e.call(this[l], i, l);
                    if (o)
        ...
        ot.extend({
            ...
            css: function(t, e, n, i) {
                var o, r, s, a = ot.camelCase(e);
                return e = ot.cssProps[a] || (ot.cssProps[a] = k(t.style, a)), s = ot.cssHooks[e] || ot.cssHooks[a], s && "get" in s && (r = s.get(t, !0, n)), void 0 === r && (r = ee(t, e, i)), "normal" === r && e in de && (r = de[e]), "" === n || n ? (o = parseFloat(r), n === !0 || ot.isNumeric(o) ? o || 0 : r) : r
            }
            ...
            be = {
                "*": [function(t, e) {
                    var n = this.createTween(t, e),
                        ...
                        s = (ot.cssNumber[t] || "px" !== r && +i) && ve.exec(ot.css(n.elem, t)),
                        a = 1,
                        l = 20;
                    if (s && s[3] !== r) {
                        r = r || s[3], o = o || [], s = +i || 1;
        ...
        ot.fn.extend({
            ...
            removeAttr: function(t, e) {
                var n, i, o = 0,
                    r = e && e.match(bt);
                if (r && 1 === t.nodeType)
                    for (; n = r[o++];) i = ot.propFix[n] || n, ot.expr.match.bool.test(n) ? Ne && Se || !Ee.test(n) ? t[i] = !1 : t[ot.camelCase("default-" + n)] = t[i] = !1 : ot.attr(t, n, ""), t.removeAttribute(Se ? n : i)
            },
            attrHooks: {
                type: {
                    set: function(t, e) {
            ...
            set: function(t, e, n) {
                return e === !1 ? ot.removeAttr(t, n) : Ne && Se || !Ee.test(n) ? t.setAttribute(!Se && ot.propFix[n] || n, n) : t[ot.camelCase("default-" + n)] = t[n] = !0, n
            }
        }, ot.each(ot.expr.match.bool.source.match(/\w+/g), function(t, e) {
            var n = Ce[e] || ot.find.attr;
            Ce[e] = Ne && Se || !Ee.test(e) ? function(t, e, i) {
                var o, r;
        ...
        Oe = qe.exec(Ie.toLowerCase()) || [], ot.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajax: function(t, e) {
                function n(t, e, n, i) {
                    var o, c, m, y, x, T = e;
                    2 !== b && (b = 2, a && clearTimeout(a), u = void 0, s = i || "", w.readyState = t > 0 ? 4 : 0, o = t >= 200 && 300 > t || 304 === t, n && (y = B(d, w, n)), y = W(d, y, w, o), o ? (d.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (ot.lastModified[r] = x), x = w.getResponseHeader("etag"), x && (ot.etag[r] = x)), 204 === t || "HEAD" === d.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = y.state, c = y.data, m = y.error, o = !m)) : (m = T, !t && T || (T = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || T) + "", o ? h.resolveWith(p, [c, T, w]) : h.rejectWith(p, [w, T, m]), w.statusCode(v), v = void 0, l && f.trigger(o ? "ajaxSuccess" : "ajaxError", [w, d, o ? c : m]), g.fireWith(p, [w, T]), l && (f.trigger("ajaxComplete", [w, d]), --ot.active || ot.event.trigger("ajaxStop")))
                }
                ...
                if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || Ie) + "").replace(He, "").replace(Fe, Oe[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = ot.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (i = qe.exec(d.url.toLowerCase()), d.crossDomain = !(!i || i[1] === Oe[1] && i[2] === Oe[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (Oe[3] || ("http:" === Oe[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ot.param(d.data, d.traditional)), F(Be, d, e, w), 2 === b) return w;
                l = ot.event && d.global, l && 0 === ot.active++ && ot.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Me.test(d.type), r = d.url, d.hasContent || (d.data && (r = d.url += (je.test(r) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Re.test(r) ? r.replace(Re, "$1_=" + Ae++) : r + (je.test(r) ? "&" : "?") + "_=" + Ae++)), d.ifModified && (ot.lastModified[r] && w.setRequestHeader("If-Modified-Since", ot.lastModified[r]), ot.etag[r] && w.setRequestHeader("If-None-Match", ot.etag[r])), (d.data && d.hasContent && d.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + ze + "; q=0.01" : "") : d.accepts["*"]);
        ...
        ot.param = function(t, e) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !ot(this).is(":disabled") && Je.test(this.nodeName) && !Ye.test(t) && (this.checked || !At.test(t))
                }).map(function(t, e) {
                    var n = ot(this).val();
...
function(t) {
    ...
    function n(e, n) {
        function N(e) {
            if (!(at() || t(e.target).closest(n.excludedElements, Bt).length > 0)) {
                var i, o = e.originalEvent ? e.originalEvent : e,
                    r = E ? o.touches[0] : o;
                return Wt = x, E ? zt = o.touches.length : e.preventDefault(), Ot = 0, It = null, Ft = null, Ht = 0, Rt = 0, _t = 0, Pt = 1, Mt = 0, Ut = pt(), qt = gt(), rt(), !E || zt === n.fingers || n.fingers === y || q() ? (ut(0, r), Xt = Et(), 2 == zt && (ut(1, o.touches[1]), Rt = _t = yt(Ut[0].start, Ut[1].start)), (n.swipeStatus || n.pinchStatus) && (i = O(o, Wt))) : i = !1, i === !1 ? (Wt = C, O(o, Wt), i) : void lt(!0)
            }
        }
        ...
        function k(t) {
            ...
            if (Wt !== T && Wt !== C && !st()) {
                var i, o = E ? e.touches[0] : e,
                    r = ct(o);
                if (Vt = Et(), E && (zt = e.touches.length), Wt = w, 2 == zt && (0 == Rt ? (ut(1, e.touches[1]), Rt = _t = yt(Ut[0].start, Ut[1].start)) : (ct(e.touches[1]), _t = yt(Ut[0].end, Ut[1].end), Ft = xt(Ut[0].end, Ut[1].end)), Pt = bt(Rt, _t), Mt = Math.abs(Rt - _t)), zt === n.fingers || n.fingers === y || !E || q()) {
                    if (It = Ct(r.start, r.end), M(t, It), Ot = wt(r.start, r.end), Ht = mt(), ft(It, Ot), (n.swipeStatus || n.pinchStatus) && (i = O(e, Wt)), !n.triggerOnTouchEnd || n.triggerOnTouchLeave) {
                        var s = !0;
                        if (n.triggerOnTouchLeave) {
                            var a = St(this);
                            s = Nt(r.end, a)
                        }!n.triggerOnTouchEnd && s ? Wt = L(w) : n.triggerOnTouchLeave && !s && (Wt = L(T)), Wt != C && Wt != T || O(e, Wt)
                    }
                } else Wt = C, O(e, Wt);
                i === !1 && (Wt = C, O(e, Wt))
            }
        ...
        function $(t) {
            ...
            return E && e.touches.length > 0 ? (ot(), !0) : (st() && (zt = Yt), t.preventDefault(), Vt = Et(), Ht = mt(), R() ? (Wt = C, O(e, Wt)) : n.triggerOnTouchEnd || 0 == n.triggerOnTouchEnd && Wt === w ? (Wt = T, O(e, Wt)) : !n.triggerOnTouchEnd && Q() ? (Wt = T, I(e, Wt, f)) : Wt === w && (Wt = C, O(e, Wt)), void lt(!1))
        }

        function D() {
            zt = 0, Vt = 0, Xt = 0, Rt = 0, _t = 0, Pt = 1, rt(), lt(!1)
        }

        function A(t) {
            var e = t.originalEvent;
            n.triggerOnTouchLeave && (Wt = L(T), O(e, Wt))
        }

        function j() {
            Bt.unbind($t, N), Bt.unbind(Lt, D), Bt.unbind(Dt, k), Bt.unbind(At, $), jt && Bt.unbind(jt, A), lt(!1)
        }
        ...
        function L(t) {
            var e = t,
                ...
                o = H(),
                r = R();
            return !i || r ? e = C : !o || t != w || n.triggerOnTouchEnd && !n.triggerOnTouchLeave ? !o && t == T && n.triggerOnTouchLeave && (e = C) : e = T, e
        }

        function O(t, e) {
            var n = void 0;
            return U() || z() ? n = I(t, e, d) : (B() || q()) && n !== !1 && (n = I(t, e, p)), nt() && n !== !1 ? n = I(t, e, h) : it() && n !== !1 ? n = I(t, e, g) : et() && n !== !1 && (n = I(t, e, f)), e === C && D(t), e === T && (E ? 0 == t.touches.length && D(t) : D(t)), n
        }

        function I(e, u, c) {
            var v = void 0;
            if (c == d) {
                if (Bt.trigger("swipeStatus", [u, It || null, Ot || 0, Ht || 0, zt]), n.swipeStatus && (v = n.swipeStatus.call(Bt, e, u, It || null, Ot || 0, Ht || 0, zt), v === !1)) return !1;
                if (u == T && W()) {
                    if (Bt.trigger("swipe", [It, Ot, Ht, zt]), n.swipe && (v = n.swipe.call(Bt, e, It, Ot, Ht, zt), v === !1)) return !1;
                    switch (It) {
                        case i:
                            Bt.trigger("swipeLeft", [It, Ot, Ht, zt]), n.swipeLeft && (v = n.swipeLeft.call(Bt, e, It, Ot, Ht, zt));
                            break;
                        case o:
                            Bt.trigger("swipeRight", [It, Ot, Ht, zt]), n.swipeRight && (v = n.swipeRight.call(Bt, e, It, Ot, Ht, zt));
                            break;
                        case r:
                            Bt.trigger("swipeUp", [It, Ot, Ht, zt]), n.swipeUp && (v = n.swipeUp.call(Bt, e, It, Ot, Ht, zt));
                            break;
                        case s:
                            Bt.trigger("swipeDown", [It, Ot, Ht, zt]), n.swipeDown && (v = n.swipeDown.call(Bt, e, It, Ot, Ht, zt))
                    }
                }
            }
            if (c == p) {
                if (Bt.trigger("pinchStatus", [u, Ft || null, Mt || 0, Ht || 0, zt, Pt]), n.pinchStatus && (v = n.pinchStatus.call(Bt, e, u, Ft || null, Mt || 0, Ht || 0, zt, Pt), v === !1)) return !1;
                if (u == T && F()) switch (Ft) {
                    case a:
                        Bt.trigger("pinchIn", [Ft || null, Mt || 0, Ht || 0, zt, Pt]), n.pinchIn && (v = n.pinchIn.call(Bt, e, Ft || null, Mt || 0, Ht || 0, zt, Pt));
                        break;
                    case l:
                        Bt.trigger("pinchOut", [Ft || null, Mt || 0, Ht || 0, zt, Pt]), n.pinchOut && (v = n.pinchOut.call(Bt, e, Ft || null, Mt || 0, Ht || 0, zt, Pt))
                }
            }
            return c == f ? u !== C && u !== T || (clearTimeout(Gt), Y() && !K() ? (Jt = Et(), Gt = setTimeout(t.proxy(function() {
                Jt = null, Bt.trigger("tap", [e.target]), n.tap && (v = n.tap.call(Bt, e, e.target))
            }, this), n.doubleTapThreshold)) : (Jt = null, Bt.trigger("tap", [e.target]), n.tap && (v = n.tap.call(Bt, e, e.target)))) : c == h ? u !== C && u !== T || (clearTimeout(Gt), Jt = null, Bt.trigger("doubletap", [e.target]), n.doubleTap && (v = n.doubleTap.call(Bt, e, e.target))) : c == g && (u !== C && u !== T || (clearTimeout(Gt), Jt = null, Bt.trigger("longtap", [e.target]), n.longTap && (v = n.longTap.call(Bt, e, e.target)))), v
        }
        ...
        function R() {
            var t = !1;
            return null !== n.cancelThreshold && null !== It && (t = ht(It) - Ot >= n.cancelThreshold), t
        }
        ...
        function P() {
            var t;
            return t = n.maxTimeThreshold ? !(Ht >= n.maxTimeThreshold) : !0
        }
            ...
            if (n.allowPageScroll === u || q()) t.preventDefault();
                ...
                switch (e) {
                    ...
                    case o:
                        ...
                        break;
                    case r:
                        (n.swipeUp && a || !a && n.allowPageScroll != m) && t.preventDefault();
                        break;
                    case s:
                        (n.swipeDown && a || !a && n.allowPageScroll != m) && t.preventDefault()
                }
            }
        }
        ...
        function X() {
            return zt === n.fingers || n.fingers === y || !E
        }
        ...
        function G() {
            if (null == Jt) return !1;
            var t = Et();
            return Y() && t - Jt <= n.doubleTapThreshold
        }
        ...
        function Z() {
            return (1 === zt || !E) && (isNaN(Ot) || 0 === Ot)
        }

        function tt() {
            return Ht > n.longTapThreshold && b > Ot
        }
        ...
        function ot() {
            Qt = Et(), Yt = event.touches.length + 1
        }
        ...
        function at() {
            return !(Bt.data(S + "_intouch") !== !0)
        }

        function lt(t) {
            t === !0 ? (Bt.bind(Dt, k), Bt.bind(At, $), jt && Bt.bind(jt, A)) : (Bt.unbind(Dt, k, !1), Bt.unbind(At, $, !1), jt && Bt.unbind(jt, A, !1)), Bt.data(S + "_intouch", t === !0)
        }

        function ut(t, e) {
            var n = void 0 !== e.identifier ? e.identifier : 0;
            return Ut[t].identifier = n, Ut[t].start.x = Ut[t].end.x = e.pageX || e.clientX, Ut[t].start.y = Ut[t].end.y = e.pageY || e.clientY, Ut[t]
        }
        ...
        function ft(t, e) {
            e = Math.max(e, ht(t)), qt[t].distance = e
        }
        ...
        function gt() {
            var t = {};
            return t[i] = vt(i), t[o] = vt(o), t[r] = vt(r), t[s] = vt(s), t
        }
        ...
        var kt = E || !n.fallbackToMouseEvents,
            $t = kt ? "touchstart" : "mousedown",
            Dt = kt ? "touchmove" : "mousemove",
            At = kt ? "touchend" : "mouseup",
            jt = kt ? null : "mouseleave",
            Lt = "touchcancel",
            Ot = 0,
            It = null,
            Ht = 0,
            ...
            Gt = null;
        try {
            Bt.bind($t, N), Bt.bind(Lt, D)
        } catch (Kt) {
            t.error("events not supported " + $t + "," + Lt + " on jQuery.swipe")
        }
        this.enable = function() {
            return Bt.bind($t, N), Bt.bind(Lt, D), Bt
        }, this.disable = function() {
            return j(), Bt
        }, this.destroy = function() {
            return j(), Bt.data(S, null), Bt
    ...
    t.fn.swipe = function(n) {
        ...
        return i
    }, t.fn.swipe.defaults = N, t.fn.swipe.phases = {
        PHASE_START: x,
        PHASE_MOVE: w,
        PHASE_END: T,
        PHASE_CANCEL: C
    ...
    t.fn.recliner = function(e) {
        function n(n) {
            var o = t(n),
                r = o.attr(e.attrib);
            if (type = o.prop("tagName"), r) {
                if ("IMG" != type && "IFRAME" != type) return o.addClass("lazy-loading"), void o.load(r, function() {
                    i(o)
                });
                o.attr("src", r)
            }
        ...
        function o() {
            var n = u.filter(function() {
                ...
                if ("none" != n.css("display")) {
                    var i = "undefined" != typeof window.innerHeight ? window.innerHeight : l.height(),
                        o = l.scrollTop(),
                        r = o + i,
                        s = n.offset().top,
                        a = s + n.height();
                    return a >= o - e.threshold && s <= r + e.threshold
                }
            });
            s = n.trigger("lazyload"), u = u.not(s)
        }
